  ...
  return (
    <>
      <Row className='align-items-center mb-4'>
        ...
        <Col xs='auto'>
          <Stack gap={2} direction='horizontal'>
            ...
            <Button onClick={() => setEditTagsModalShow(true)} variant='outline-secondary'>Edit Tags</Button>
          </Stack>
        </Col>
      </Row>
      <Form>
      ...
      <EditTagsModal
        ...
        handleClose={() => setEditTagsModalShow(false)} availableTags={availableTags}
      />
    </>
  )
}
        ...
        >
          <span className='fs-5'>{title}</span>
          {
            tags.length > 0 && (
              <Stack
                gap={1}
                direction='horizontal' className='justify-content-center flex-wrap'
              >
                {
                  tags.map(tag => (
